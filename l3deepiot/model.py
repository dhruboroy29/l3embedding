...
'''
@gpu_wrapper
def construct_cnn_L3_melspec2(name='cnn_L3_melspec2', reuse=False):
    """
...
def construct_cnn_L3_melspec2_audio_model(batch_size=64, train=True, reuse=False, name='audio_model'):
    """
...
# Vision model
def construct_cnn_L3_orig_vision_model(batch_size=64, name='vision_model', reuse=False):
    """
...
# Merge models
def L3_merge_audio_vision_models(vision_model, x_i, audio_model, x_a, model_name, layer_size=128, name='concat', reuse=False):
    """
